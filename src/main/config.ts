...
export const RELEASES_API_URL = "https://api.github.com/repos/effy46/PawPal/releases/latest";
export const RELEASES_URL = "https://github.com/effy46/PawPal/releases";
